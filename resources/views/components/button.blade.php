...
@php
    ...
    switch ($variant) {
        case 'primary':
            $variantClasses = 'bg-blue-950 text-white hover:bg-blue-800 focus:ring-blue-950';
            break;
        case 'secondary':
            $variantClasses = 'bg-white text-gray-500 hover:bg-gray-100 focus:ring-blue-800 dark:text-gray-400 dark:bg-dark-eval-1 dark:hover:bg-dark-eval-2 dark:hover:text-gray-200';
            break;
        case 'success':
